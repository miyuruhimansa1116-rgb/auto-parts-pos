      ...
      <main className="min-h-screen bg-slate-50 dark:bg-slate-950 flex items-center justify-center">
        <div className="flex flex-col items-center gap-5">
          ...
          <div className="flex flex-col items-center gap-1">
            ...
            <p className="text-xs text-slate-400">Please wait while data is being prepared</p>
          </div>
        </div>
      </main>
    );
    ...
    <main className="min-h-screen bg-slate-50 dark:bg-slate-950 text-slate-900 dark:text-white">
      <div className="mx-auto max-w-[1450px] px-3 py-4 sm:px-6 lg:px-8 lg:py-7">
        ...
        <header className="mb-6 flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
          <div>
            <div className="mb-2 inline-flex items-center gap-2 rounded-full border border-blue-100 bg-blue-50 px-3.5 py-1.5 text-xs font-bold uppercase tracking-[0.14em] text-blue-700 dark:border-blue-900/50 dark:bg-blue-950/40 dark:text-blue-300">
          ...
          <div className="flex flex-wrap gap-2">
            <button
              ...
              className="inline-flex items-center justify-center gap-2 rounded-xl border border-slate-200 bg-white px-4 py-2.5 text-xs sm:text-sm font-bold text-slate-700 shadow-sm transition hover:bg-slate-50 dark:border-slate-800 dark:bg-slate-900 dark:text-slate-200 dark:hover:bg-slate-800"
            >
              <RefreshCw
            ...
            <Link
              href="/pos"
              className="inline-flex items-center justify-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-xs sm:text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition hover:-translate-y-0.5 hover:bg-blue-700"
            >
        ...
        <section className="mb-6 rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            ...
            <div className="flex flex-wrap items-center gap-1.5 sm:gap-2">
              {[
                ...
                <button
                  ...
                  className={`rounded-lg px-3.5 py-2 text-xs sm:text-sm font-bold transition ${
                    timeFilter === value
          ...
          {timeFilter === "custom" && (
            <div className="mt-4 grid grid-cols-1 gap-3 border-t border-slate-100 pt-3 sm:grid-cols-2 dark:border-slate-800">
              <label className="text-xs font-semibold text-slate-500">
                ...
                <input
                  ...
                  className="mt-1.5 w-full rounded-xl border border-slate-200 bg-slate-50 px-3.5 py-2.5 text-sm outline-none focus:border-blue-500 focus:ring-2 focus:ring-blue-500/10 dark:border-slate-700 dark:bg-slate-800"
                />
              </label>
              <label className="text-xs font-semibold text-slate-500">
                To
        ...
        <section className="mb-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between mb-3">
              <div>
                <p className="text-sm font-black uppercase tracking-wider text-slate-400">Quick actions</p>
              ...
              {[
                ...
                return (
                  <Link
                    href={href as string}
                    key={label as string}
                    className="group flex items-center gap-3 rounded-xl border border-slate-100 p-3.5 transition hover:border-slate-200 hover:bg-slate-50 dark:border-slate-800 dark:hover:bg-slate-800"
                  >
                    <div
                      className={`flex h-10 w-10 shrink-0 items-center justify-center rounded-xl ${toneClasses[tone as string]}`}
                    >
                    ...
                    <div className="min-w-0">
                      ...
                      <ArrowRight className="mt-0.5 h-3.5 w-3.5 text-slate-300 transition group-hover:translate-x-0.5 group-hover:text-slate-500" />
                    </div>
                  </Link>
                );
              })}
        ...
        <section className="mb-6 grid grid-cols-1 gap-3 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6">
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-1 truncate text-2xl font-black tracking-tight">
              {money(periodRevenue)}
            </p>
            <p className="mt-1 text-xs text-slate-400">Sales income</p>
          </div>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900 flex flex-col justify-between">
            <div>
              ...
              <p className="mt-1 truncate text-2xl font-black tracking-tight text-emerald-600 dark:text-emerald-400">
                {money(periodProfit)}
              </p>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-1 text-xs text-slate-400">Total buying price</p>
          </div>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-1 text-xs text-slate-400">{totalItemsSold.toLocaleString()} items sold</p>
          </div>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-1 text-xs text-slate-400">Inventory items</p>
          </div>
          ...
          <div className="group rounded-2xl border border-slate-200 bg-white p-4 shadow-sm transition hover:-translate-y-0.5 hover:shadow-md dark:border-slate-800 dark:bg-slate-900">
            ...
            <p className="mt-1 text-xs text-slate-400">{lowStockCount ? "Needs attention" : "Stock is healthy"}</p>
          </div>
        </section>
        ...
        <section className="mb-6">
          <div className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-base font-black">Sales overview</p>
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black">Top selling items</h2>
                  <p className="text-xs text-slate-400">
                    Most sold items in selected period
                  </p>
                </div>
              </div>
              <span className="rounded-full bg-orange-50 px-3 py-1 text-xs font-bold text-orange-600 dark:bg-orange-950/40 dark:text-orange-300">
            ...
            {topSellingItems.length === 0 ? (
              <div className="flex min-h-44 flex-col items-center justify-center px-5 text-center">
                <ShoppingBag className="mb-2 h-7 w-7 text-slate-300" />
                <p className="text-sm font-bold">No sales records</p>
                <p className="mt-1 text-xs text-slate-400">
              ...
              <div className="overflow-x-auto">
                <table className="w-full min-w-[500px] text-left">
                  <thead className="bg-slate-50 text-xs font-bold uppercase tracking-wider text-slate-400 dark:bg-slate-800/50">
                    <tr>
                      <th className="px-5 py-3.5">Part No. / Product</th>
                    ...
                    {topSellingItems.map((item, idx) => (
                      ...
                      >
                        <td className="px-5 py-3.5">
                          ...
                          <p className="mt-0.5 text-xs text-blue-600 dark:text-blue-300 font-semibold">
                            {item.partNumber}
                          </p>
                        </td>
                        <td className="px-5 py-3.5">
                          <span className="rounded-md bg-slate-100 px-2.5 py-1 text-xs font-bold text-slate-500 dark:bg-slate-800 dark:text-slate-400">
                            {item.category}
                          </span>
                        </td>
                        <td className="px-5 py-3.5 text-center">
                          <span className="rounded-lg bg-orange-50 px-3 py-1.5 text-xs font-black text-orange-600 dark:bg-orange-950/40 dark:text-orange-300">
                            {item.qty} units
                          </span>
                        </td>
                        <td className="px-5 py-3.5 text-right text-sm font-black text-emerald-600 dark:text-emerald-400">
                          {money(item.revenue)}
                        </td>
                      </tr>
                    ))}
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black">Low stock</h2>
                  <p className="text-xs text-slate-400">
            ...
            {lowStockProducts.length === 0 ? (
              <div className="flex min-h-44 flex-col items-center justify-center px-5 text-center">
                <div className="mb-2 flex h-11 w-11 items-center justify-center rounded-full bg-emerald-50 text-emerald-600 dark:bg-emerald-950/40 dark:text-emerald-300">
                  <Package className="h-6 w-6" />
                </div>
                <p className="text-sm font-bold">Stock looks healthy</p>
                <p className="mt-1 text-xs text-slate-400">
                ...
                <table className="w-full min-w-[500px] text-left">
                  ...
                  <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                    {lowStockProducts.map((p) => (
                      ...
                      >
                        <td className="px-5 py-3.5 text-sm font-bold text-blue-600 dark:text-blue-300">
                          {p.partNumber || "-"}
                        </td>
                        <td className="px-5 py-3.5">
                          <p className="max-w-[160px] truncate text-sm font-bold">
                            {p.name || "N/A"}
                          </p>
                        </td>
                        <td className="px-5 py-3.5 text-center">
                          <span className="rounded-lg bg-red-50 px-3 py-1.5 text-xs font-black text-red-600 dark:bg-red-950/40 dark:text-red-300">
                            {p.stockQty || 0}
                          </span>
                        </td>
                        <td className="px-5 py-3.5 text-right text-sm font-black">
        ...
        {/* Recent sales & Supplier Purchases */}
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black">Recent bills</h2>
                  <p className="text-xs text-slate-400">
                ...
                recentSales.map((sale, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="shrink-0 text-sm font-black text-emerald-600 dark:text-emerald-300">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-slate-800 dark:bg-slate-900">
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-4 dark:border-slate-800">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h2 className="text-base font-black">Supplier purchases</h2>
                  <p className="text-xs text-slate-400">
                ...
                {recentPurchases.map((p, idx) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <p className="shrink-0 text-sm font-black text-amber-600 dark:text-amber-300">
            ...
            <div className="w-full max-w-md rounded-2xl bg-white p-6 shadow-2xl dark:bg-slate-900 border border-slate-200 dark:border-slate-800">
              <div className="flex items-center justify-between border-b border-slate-100 pb-4 dark:border-slate-800">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="text-base font-black">Low Stock Item Details</h3>
                    <p className="text-xs text-slate-400">Product inventory info</p>
                  </div>
                </div>
                <button
              ...
              <div className="mt-4 space-y-3.5">
                <div className="rounded-xl bg-slate-50 p-3.5 dark:bg-slate-800/50">
                  ...
                  <p className="text-base font-bold text-slate-800 dark:text-slate-100 mt-1">{selectedProduct.name || "N/A"}</p>
                </div>

                <div className="grid grid-cols-2 gap-3.5">
                  <div className="rounded-xl bg-slate-50 p-3.5 dark:bg-slate-800/50">
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Part Number</p>
                    <p className="text-sm font-bold text-blue-600 dark:text-blue-300 mt-1">{selectedProduct.partNumber || "-"}</p>
                  </div>
                  <div className="rounded-xl bg-slate-50 p-3.5 dark:bg-slate-800/50">
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Current Stock</p>
                    <p className="text-sm font-black text-red-600 dark:text-red-400 mt-1">{selectedProduct.stockQty || 0} Units</p>
                  </div>
                </div>
                ...
                <div className="grid grid-cols-2 gap-3.5">
                  <div className="rounded-xl bg-slate-50 p-3.5 dark:bg-slate-800/50">
                    ...
                    <p className="text-sm font-bold text-slate-800 dark:text-slate-100 mt-1">{money(Number(selectedProduct.sellingPrice || 0))}</p>
                  </div>
                  <div className="rounded-xl bg-slate-50 p-3.5 dark:bg-slate-800/50">
                    <p className="text-xs font-bold uppercase tracking-wider text-slate-400">Category</p>
                    <p className="text-sm font-bold text-slate-800 dark:text-slate-100 mt-1">{selectedProduct.category || "General"}</p>
                  </div>
                </div>
              </div>
              ...
              <div className="mt-6 flex justify-end gap-2.5">
                <Link
                  href="/products"
                  className="inline-flex items-center gap-2 rounded-xl bg-blue-600 px-4 py-2.5 text-xs sm:text-sm font-bold text-white shadow-md hover:bg-blue-700"
                >
                  Manage Products
                ...
                <button
                  onClick={() => setSelectedProduct(null)}
                  className="rounded-xl border border-slate-200 px-4 py-2.5 text-xs sm:text-sm font-bold text-slate-600 hover:bg-slate-50 dark:border-slate-700 dark:text-slate-300 dark:hover:bg-slate-800"
                >
                  Close
                </button>
              </div>
        ...
        <footer className="mt-6 flex flex-col gap-1.5 px-1 text-xs text-slate-400 sm:flex-row sm:items-center sm:justify-between">
